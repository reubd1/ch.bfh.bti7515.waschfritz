...
(function (M, Y, t) {
    ...
    function T(b) {
        return function () {
            var a = arguments[0], c;
            c = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.3.7/" + (b ? b + "/" : "") + a;
    ...
    function Sa(b) {
        ...
        var a = b.length;
        return b.nodeType ===
            na && a ? !0 : H(b) || x(b) || 0 === a || "number" === typeof a && 0 < a && a - 1 in b
    }

    function s(b, a, c) {
        var d, e;
        if (b)if (G(b))for (d in b)"prototype" == d || "length" == d || "name" == d || b.hasOwnProperty && !b.hasOwnProperty(d) || a.call(c, b[d], d, b); else if (x(b) || Sa(b)) {
    ...
    function Ea(b, a, c, d) {
        ...
        if (a) {
            ...
            if (x(b))for (var f = a.length = 0; f < b.length; f++)e = Ea(b[f], null, c, d), P(b[f]) && (c.push(b[f]), d.push(e)), a.push(e); else {
                var g = a.$$hashKey;
                x(a) ? a.length =
                    0 : s(a, function (b, c) {
                    delete a[c]
                });
                for (f in b)b.hasOwnProperty(f) && (e = Ea(b[f], null, c, d), P(b[f]) && (c.push(b[f]), d.push(e)), a[f] = e);
                lc(a, g)
            }
        } else if (a = b)x(b) ? a = Ea(b, [], c, d) : pa(b) ? a = new Date(b.getTime()) : ob(b) ? (a = new RegExp(b.source, b.toString().match(/[^\/]*$/)[0]), a.lastIndex = b.lastIndex) : P(b) && (e = Object.create(Object.getPrototypeOf(b)), a = Ea(b, e, c, d));
        return a
    }
    ...
    function qa(b, a) {
        ...
        } else if (P(b))for (c in a = a || {}, b)if ("$" !== c.charAt(0) || "$" !== c.charAt(1))a[c] =
            b[c];
        return a || b
    }
    ...
    function fa(b, a) {
        ...
        if (c == typeof a && "object" == c)if (x(b)) {
            ...
            if (Ua(b) || Ua(a) || Ta(b) || Ta(a) || x(a))return!1;
            c = {};
    ...
    function Hd(b, a) {
        var c = a;
        "string" === typeof b && "$" === b.charAt(0) && "$" === b.charAt(1) ? c = t : Ta(a) ? c = "$WINDOW" : a && Y === a ? c = "$DOCUMENT" : Ua(a) &&
            (c = "$SCOPE");
        return c
    }
    ...
    function Id(b, a) {
        var c, d, e = rb.length;
        b = B(b);
        for (d = 0; d < e; ++d)if (c = rb[d] + a, H(c = b.attr(c)))return c;
        return null
    }
    ...
    function Nd() {
        var b;
        uc || ((ra = M.jQuery) && ra.fn.on ? (B = ra, z(ra.fn, {scope: Ka.scope, isolateScope: Ka.isolateScope, controller: Ka.controller, injector: Ka.injector, inheritedData: Ka.inheritedData}), b = ra.cleanData, ra.cleanData = function (a) {
            var c;
        ...
        return a(b, "module", function () {
            ...
            return function (f, g, h) {
                ...
                return a(b, f, function () {
                    ...
                    var b = [], d = [], e = [], q = a("$injector", "invoke", "push", d), u = {_invokeQueue: b, _configBlocks: d, _runBlocks: e, requires: g, name: f, provider: a("$provide",
                        "provider"), factory: a("$provide", "factory"), service: a("$provide", "service"), value: a("$provide", "value"), constant: a("$provide", "constant", "unshift"), animation: a("$animateProvider", "register"), filter: a("$filterProvider", "register"), controller: a("$controllerProvider", "register"), directive: a("$compileProvider", "directive"), config: q, run: function (a) {
                        e.push(a);
                        return this
                    }};
                    h && q(h);
    ...
    function Pd(b) {
        z(b, {bootstrap: sc, copy: Ea, extend: z, equals: fa, element: B, forEach: s, injector: Ob, noop: C, bind: nc, toJson: Za,
            fromJson: oc, identity: oa, isUndefined: D, isDefined: y, isString: H, isFunction: G, isObject: P, isNumber: V, isElement: mc, isArray: x, version: Qd, isDate: pa, lowercase: Q, uppercase: ub, callbacks: {counter: 0}, getTestability: Ld, $$minErr: T, $$csp: $a, reloadWithDebugInfo: Kd});
        ab = Od(M);
        try {
            ab("ngLocale")
        } catch (a) {
            ab("ngLocale", []).provider("$locale", Rd)
        }
    ...
    function bf() {
        this.$get = function () {
            return z(R, {hasClass: function (b, a) {
                b.attr && (b = b[0]);
                return Ab(b, a)
    ...
    function Vb(b, a, c) {
        ...
        if ("function" === typeof b) {
            if (!(d = b.$inject)) {
                d = [];
                if (b.length) {
                    if (a)throw H(c) && c || (c = b.name || mf(b)), Ga("strictdi", c);
    ...
    function Ob(b, a) {
        function c(a) {
            return function (b, c) {
                if (P(b))s(b, kc(a)); else return a(b, c)
            }
        }
        ...
        function g(a) {
            ...
            s(a, function (a) {
                ...
                if (!m.get(a)) {
                    m.put(a, !0);
                    try {
                        H(a) ? (c = ab(a), b = b.concat(g(c.requires)).concat(c._runBlocks), d(c._invokeQueue), d(c._configBlocks)) : G(a) ? b.push(q.invoke(a)) : x(a) ? b.push(q.invoke(a)) : sb(a, "module")
                    } catch (e) {
                        throw x(a) &&
        ...
        a = !0 === a;
        var l = {}, k = [], m = new cb([], !0), n = {$provide: {provider: c(d), factory: c(f), service: c(function (a, b) {
    ...
    function pf(b, a, c, d) {
        ...
        function l() {
            if (E !== m.url() || F !== A)E = m.url(), F = A, s(W, function (a) {
                a(m.url(), A)
            })
        }
        ...
        var A, F, E = q.href, S = a.find("base"), X = null;
        h();
        F = A;
        m.url = function (a, c, e) {
            ...
            if (a) {
                ...
                E = a;
                F = e;
                !d.history || g && f ? (g || (X = a), c ? q.replace(a) : g ? (c = q, e = a.indexOf("#"), a = -1 === e ? "" : a.substr(e + 1), c.hash = a) : q.href = a) : (u[c ? "replaceState" : "pushState"](e, "", a), h(), F = A);
                return m
            }
        ...
        m.cookies = function (a, b) {
            var d, e, f, g;
            if (a)b === t ? n.cookie = encodeURIComponent(a) + "=;path=" + ca + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : H(b) && (d = (n.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) +
                ";path=" + ca).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!")); else {
                if (n.cookie !== y)for (y = n.cookie, d = y.split("; "), ea = {}, f = 0; f < d.length; f++)e = d[f], g = e.indexOf("="), 0 < g && (a = k(e.substring(0, g)), ea[a] === t && (ea[a] = k(e.substring(g + 1))));
                return ea
            }
        };
        ...
        m.defer.cancel = function (a) {
            return p[a] ? (delete p[a], O(a), e(C), !0) : !1
        }
    }
    ...
    function wc(b, a) {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, r, O, p, v, w, L, J, A) {
            function F(a, b) {
                try {
                    a.addClass(b)
                } catch (c) {
                ...
                switch (a.nodeType) {
                    case na:
                        ...
                        for (var k, q, n, r = a.attributes, p = 0, w = r && r.length; p < w; p++) {
                            ...
                            q = U(k.value);
                            k = ya(l);
                            if (n = eb.test(k))l = l.replace(Rc, "").substr(8).replace(/_(.)/g, function (a, b) {
                        ...
                        a = a.className;
                        if (H(a) && "" !== a)for (; l = f.exec(a);)k = ya(l[2]), ca(b, k, "C", d, g) && (c[k] = U(l[3])), a = a.substr(l.index + l[0].length);
                        break;
                    case pb:
                        M(b, a.nodeValue);
                        break;
            ...
            function ea(a, d, e, f, g, l, k, n, r) {
                ...
                function v(a, c, f, g, h) {
                    ...
                    S && (A = c.$new(!0));
                    h && (db = l, db.$$boundTransclude = h);
                    J && (X = {}, F = {}, s(J, function (a) {
                        var b = {$scope: a === S || a.$$isolateScope ? A : c, $element: W, $attrs: I, $transclude: db};
                        u = a.controller;
                        "@" == u && (u = I[a.name]);
                    ...
                    g = 0;
                    for (r = k.length; g < r; g++)w = k[g], $(w, w.isolateScope ? A : c, W, I, w.require && L(w.directiveName, w.require, W, F), db);
                    var wa = c;
                    S && (S.template || null === S.templateUrl) && (wa = A);
                    a && a(wa, f.childNodes, t, h);
                    for (g = n.length - 1; 0 <= g; g--)w = n[g], $(w, w.isolateScope ? A : c, W, I, w.require && L(w.directiveName, w.require, W, F), db)
                }

                r = r || {};
                for (var A = -Number.MAX_VALUE,
                         F, J = r.controllerDirectives, X, S = r.newIsolateScopeDirective, ka = r.templateDirective, ea = r.nonTlbTranscludeDirective, ca = !1, D = !1, C = r.hasElementTranscludeDirective, aa = e.$$element = B(d), K, z, N, Aa = f, Q, M = 0, R = a.length; M < R; M++) {
                    K = a[M];
                    var Oa = K.$$start, eb = K.$$end;
                    Oa && (aa = wa(d, Oa, eb));
                    N = t;
                    if (A > K.priority)break;
                    if (N = K.scope)K.templateUrl || (P(N) ? (Na("new/isolated scope", S || F, K, aa), S = K) : Na("new/isolated scope", S, K, aa)), F = F || K;
                    z = K.name;
                    !K.templateUrl && K.controller && (N = K.controller, J = J || {}, Na("'" + z + "' controller", J[z],
                        K, aa), J[z] = K);
                    if (N = K.transclude)ca = !0, K.$$tlb || (Na("transclusion", ea, K, aa), ea = K), "element" == N ? (C = !0, A = K.priority, N = aa, aa = e.$$element = B(Y.createComment(" " + z + ": " + e[z] + " ")), d = aa[0], V(g, Ya.call(N, 0), d), Aa = E(N, f, A, l && l.name, {nonTlbTranscludeDirective: ea})) : (N = B(Tb(d)).contents(), aa.empty(), Aa = E(N, f));
                    if (K.template)if (D = !0, Na("template", ka, K, aa), ka = K, N = G(K.template) ? K.template(aa, e) : K.template, N = Sc(N), K.replace) {
                        l = K;
                    ...
                    if (K.templateUrl)D = !0, Na("template", ka, K, aa), ka = K, K.replace && (l = K), v = T(a.splice(M, a.length - M), aa, e, g, ca && Aa, k, n, {controllerDirectives: J, newIsolateScopeDirective: S, templateDirective: ka, nonTlbTranscludeDirective: ea}), R = a.length; else if (K.compile)try {
                        Q = K.compile(aa, e, Aa), G(Q) ? w(null, Q, Oa, eb) : Q && w(Q.pre, Q.post, Oa, eb)
                    } catch (qf) {
                        c(qf, va(aa))
                    }
                    K.terminal &&
            ...
            function Qc(a, b) {
                ...
                s(b, function (b, f) {
                    "class" == f ? (F(e, b), a["class"] = (a["class"] ? a["class"] + " " : "") + b) : "style" ==
            ...
            function T(a, b, c, d, e, f, g, h) {
                var l = [], k, q, n = b[0], p = a.shift(), w = z({}, p, {templateUrl: null, transclude: null, replace: null, $$originalDirective: p}), O = G(p.templateUrl) ? p.templateUrl(b, c) : p.templateUrl, u = p.templateNamespace;
                b.empty();
                r(L.getTrustedResourceUrl(O)).then(function (r) {
                    ...
                    for (q = S(b[0].childNodes, e); l.length;) {
                        ...
                        if (!r.$$destroyed) {
                            if (v !== n) {
                                var I = v.className;
                                h.hasElementTranscludeDirective && p.replace || (A = Tb(L));
                                V(J, B(v), A);
                                F(B(A), I)
                            }
            ...
            Xb.prototype = {$normalize: ya, $addClass: function (a) {
                ...
                if ("a" === g && "href" === a || "img" === g && "src" === a)this[a] = b = A(b, "src" === a); else if ("img" === g && "srcset" === a) {
                    for (var g = "", h = U(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(h) ? k : /(,)/, h = h.split(k), k = Math.floor(h.length / 2), l = 0; l < k; l++)var q = 2 * l, g = g + A(U(h[q]), !0), g = g + (" " + U(h[q + 1]));
                    h = U(h[2 * l]).split(/\s/);
                    g += A(U(h[0]), !0);
                    2 === h.length && (g += " " + U(h[1]));
                    this[a] = b = g
    ...
    function Fe() {
        ...
        this.$get = ["$injector", "$window", function (d, e) {
            function f(a, b, c, d) {
                if (!a || !P(a.$scope))throw T("$controller")("noscp", d, b);
                a.$scope[b] = c
            }
            ...
            return function (g, h, l, k) {
                ...
                k && H(k) && (q = k);
                H(g) &&
                (k = g.match(c), n = k[1], q = q || k[3], g = b.hasOwnProperty(n) ? b[n] : vc(h.$scope, n, !0) || (a ? vc(e, n, !0) : t), sb(g, n, !0));
                if (l)return l = (x(g) ? g[g.length - 1] : g).prototype, m = Object.create(l), q && f(h, q, m, n || g.name), z(function () {
                    d.invoke(g, m, h, n);
                    return m
    ...
    function Ke() {
        var b = this.defaults = {transformResponse: [Yb], transformRequest: [function (a) {
            return P(a) && "[object File]" !== Da.call(a) && "[object Blob]" !== Da.call(a) && "[object FormData]" !== Da.call(a) ? Za(a) : a
        }], headers: {common: {Accept: "application/json, text/plain, */*"}, post: qa(Zb), put: qa(Zb), patch: qa(Zb)}, xsrfCookieName: "XSRF-TOKEN", xsrfHeaderName: "X-XSRF-TOKEN"}, a = !1;
            ...
            "$rootScope", "$q", "$injector", function (d, e, f, g, h, l) {
                ...
                function m(c, f) {
                    function l(b, c, d, e) {
                        ...
                        F && (200 <= b && 300 > b ? F.put(X, [b, c, Wc(d), e]) : F.remove(X));
                        a ? g.$applyAsync(f) : (f(), g.$$phase || g.$apply())
                    }

                    function m(a, b, d, e) {
                        b = Math.max(b, 0);
                        (200 <= b && 300 > b ? J.resolve : J.reject)({data: a,
                    ...
                    var J = h.defer(), A = J.promise, F, E, s = c.headers, X = n(c.url, c.params);
                    k.pendingRequests.push(c);
                    A.then(u, u);
                    !c.cache && !b.cache || !1 === c.cache || "GET" !== c.method && "JSONP" !== c.method || (F = P(c.cache) ? c.cache : P(b.cache) ? b.cache : q);
                    F && (E = F.get(X), y(E) ? E && G(E.then) ? E.then(w, w) : x(E) ? m(E[1], E[0], qa(E[2]), E[3]) : m(E, 200, {},
                        "OK") : F.put(X, A));
    ...
    function wf(b, a, c, d, e) {
        ...
        return function (e, h, l, k, m, n, q, u) {
            ...
            if (0 < n)var J = c(r, n); else n && G(n.then) && n.then(r)
        }
    }
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce",
            function (c, d, e) {
                ...
                function g(f, g, u, r) {
                    ...
                    r = !!r;
                    for (var v, w, L = 0, J = [], A = [], F = f.length, E = [], s = []; L < F;)if (-1 != (v = f.indexOf(b, L)) && -1 != (w = f.indexOf(a, v + h)))L !== v && E.push(O(f.substring(L,
                        v))), L = f.substring(v + h, w), J.push(L), A.push(c(L, p)), L = w + l, s.push(E.length), E.push(""); else {
                        L !== F && E.push(O(f.substring(L)));
                        break
                    }
        ...
        this.$get = ["$rootScope", "$window", "$q", "$$q", function (b, a, c, d) {
            function e(e, h, l, k) {
                ...
                O.$$intervalId = m(function () {
                    r.notify(q++);
                    0 <
                    l && q >= l && (r.resolve(q), n(O.$$intervalId), delete f[O.$$intervalId]);
                    u || b.$apply()
                }, h);
                f[O.$$intervalId] = r;
                return O
    ...
    function Me() {
        ...
        this.html5Mode = function (b) {
            return Va(b) ? (a.enabled = b, this) : P(b) ? (Va(b.enabled) && (a.enabled = b.enabled), Va(b.requireBase) && (a.requireBase = b.requireBase), Va(b.rewriteLinks) && (a.rewriteLinks = b.rewriteLinks), this) : a
        };
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (c, d, e, f, g) {
            ...
            f.on("click", function (b) {
                if (a.rewriteLinks && !b.ctrlKey && !b.metaKey &&
                    ...
                    P(h) && "[object SVGAnimatedString]" === h.toString() && (h = Ba(h.animVal).href);
    ...
    function ed(b, a, c, d, e, f, g) {
        ...
        var h = function (a) {
            return ta(a, f)
        }, l = g || Pa(b) ? h : oa, k = g || Pa(a) ? h : oa, m =
                g || Pa(c) ? h : oa, n = g || Pa(d) ? h : oa, q = g || Pa(e) ? h : oa;
        return function (f, g) {
            ...
            return function (d, f, g) {
                ...
                switch (typeof d) {
                    case "string":
                        ...
                        var J = g ? a : b;
                        v = J[L];
                        v || (":" === d.charAt(0) && ":" === d.charAt(1) && (w = !0, d = d.substring(2)), g = g ? u : q, v = new gc(g), v = (new gb(v, c, g)).parse(d), v.constant ? v.$$watchDelegate =
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function (e, f, g, h) {
            ...
            l.prototype = {constructor: l, $new: function (a, b) {
                ...
                function c(a) {
                    ...
                    var b, d, g, h;
                    if (!D(e)) {
                        if (P(e))if (Sa(e))for (f !== q && (f = q, p = f.length = 0, k++), a = e.length, p !== a && (k++, f.length = p = a), b = 0; b < a; b++)h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (k++, f[b] = g); else {
                            f !==
                            m && (f = m = {}, p = 0, k++);
                            a = 0;
                            for (b in e)e.hasOwnProperty(b) && (a++, g = e[b], h = f[b], b in f ? (d = h !== h && g !== g, d || h === g || (k++, f[b] = g)) : (p++, f[b] = g, k++));
                            if (p > a)for (b in k++, f)e.hasOwnProperty(b) || (p--, delete f[b])
                        } else f !== e && (f = e, k++);
                        return k
                    }
                }
                ...
                c.$stateful = !0;
                var d = this, e, f, h, l = 1 < b.length, k = 0, n = g(a, c), q = [], m = {}, u = !0, p = 0;
                ...
                do {
                    ...
                    a:do {
                        if (m = t.$$watchers)for (u = m.length; u--;)try {
                            if (e = m[u])if ((g = e.get(t)) !== (l = e.last) && !(e.eq ? fa(g, l) : "number" === typeof g && "number" === typeof l && isNaN(g) && isNaN(l)))v = !0, c = e, e.last = e.eq ? Ea(g, null) : g, e.fn(g, l === n ? g : l, t), 5 > s && (y = 4 - s, W[y] || (W[y] = []), W[y].push({msg: G(e.exp) ?
                                "fn: " + (e.exp.name || e.exp.toString()) : e.exp, newVal: g, oldVal: l})); else if (e === c) {
                                v = !1;
                                break a
                            }
                        } catch (D) {
                ...
                }, defaultPrevented: !1}, l = Xa([h], arguments, 1), k, n;
                do {
                    d = e.$$listeners[a] || c;
                    h.currentScope = e;
                    k = 0;
                ...
                for (var g = Xa([e], arguments, 1), h, l; c = d;) {
                    e.currentScope = c;
                    d = c.$$listeners[a] || [];
                    h = 0;
        ...
        this.$get = ["$window", "$document",
            function (b, a) {
                ...
                if (l) {
                    ...
                    !d || k && m || (k = H(f.body.style.webkitTransition), m = H(f.body.style.webkitAnimation))
                }
                return{history: !(!b.history || !b.history.pushState || 4 > d || e), hasEvent: function (a) {
                    ...
                    return c[a]
                }, csp: $a(), vendorPrefix: g, transitions: k, animations: m, android: d}
            }]
    }
    ...
    function Ba(b) {
        Qa && (Z.setAttribute("href", b), b = Z.href);
        Z.setAttribute("href", b);
        return{href: Z.href, protocol: Z.protocol ? Z.protocol.replace(/:$/, "") : "", host: Z.host, search: Z.search ? Z.search.replace(/^\?/, "") : "", hash: Z.hash ? Z.hash.replace(/^#/, "") : "", hostname: Z.hostname,
    ...
    function hb(b, a, c, d) {
        ...
        if ("string" === f && "!" === a.charAt(0))return!hb(b,
            a.substring(1), c, d);
        ...
        switch (e) {
            case "object":
                var g;
                if (d) {
                    for (g in b)if ("$" !== g.charAt(0) && hb(b[g], a, c))return!0;
                    return!1
                }
                if ("object" === f) {
                    for (g in a)if (e = a[g], !G(e) && (f = "$" === g, !hb(f ? b : b[g], e, c, f)))return!1;
                    return!0
                }
                return c(b, a);
            case "function":
    ...
    function jd(b) {
        ...
        return function (b, d, e) {
            ...
            return null == b ? b : nd(b, a.PATTERNS[1], a.GROUP_SEP,
    ...
    function kd(b) {
        ...
        return function (c, e, f) {
            ...
            H(c) && (c = Kf.test(c) ? ba(c) : a(c));
            V(c) && (c = new Date(c));
            if (!pa(c))return c;
            for (; e;)(k = Lf.exec(e)) ? (h = Xa(h, k, 1), e = h.pop()) : (h.push(e), e = null);
    ...
    function Gf() {
        return function (b, a) {
            ...
            if (H(b))return a ? 0 <= a ? b.slice(0, a) : b.slice(a, b.length) : "";
            var c = [], d, e;
    ...
    function md(b) {
        return function (a, c, d) {
            ...
            function g(a) {
                return null === a ? "null" : "function" === typeof a.toString && (a = a.toString(), f(a)) || "function" === typeof a.valueOf && (a = a.valueOf(), f(a)) ? a : ""
            }
    ...
    function rd(b, a, c, d, e) {
        ...
        f.$setPristine = function () {
            d.setClass(b, Ra, Kb + " ng-submitted");
            f.$dirty = !1;
            f.$pristine = !0;
            f.$submitted = !1;
            s(g, function (a) {
    ...
    function ib(b, a, c, d, e, f) {
        ...
        var l = function (b) {
            ...
            if (!h) {
                var e = a.val();
                b = b && b.type;
                "password" === g || c.ngTrim && "false" === c.ngTrim ||
                (e = U(e));
    ...
    function td(b, a, c, d) {
        (d.$$hasNativeValidators = P(a[0].validity)) && d.$parsers.push(function (b) {
    ...
    function sd(b) {
        ...
        d.$setValidity = function (b, e, f) {
            ...
            Va(e) ?
                e ? (h(d.$error, b, f), g(d.$$success, b, f)) : (g(d.$error, b, f), h(d.$$success, b, f)) : (h(d.$error, b, f), h(d.$$success, b, f));
    ...
    var Of = /^\/(.+)\/([a-z]*)$/, Q = function (b) {
        ...
        return H(b) ? b.toUpperCase() :
            b
    }, Qa, B, ra, Ya = [].slice, rf = [].splice, Pf = [].push, Da = Object.prototype.toString, Ja = T("ng"), ga = M.angular || (M.angular = {}), ab, nb = 0;
    Qa = Y.documentMode;
    C.$inject = [];
    oa.$inject = [];
    var x = Array.isArray, U = function (b) {
        ...
        return $a.isActive_ =
            b
    }, rb = ["ng-", "data-ng-", "ng:", "x-ng-"], Md = /[A-Z]/g, uc = !1, Pb, na = 1, pb = 3, Qd = {full: "1.3.7", major: 1, minor: 3, dot: 7, codeName: "leaky-obstruction"};
    R.expando = "ng339";
    var zb = R.cache = {}, hf = 1;
    R._data = function (b) {
        return this.cache[b[this.expando]] || {}
    };
    var cf = /([\:\-\_]+(.))/g, df = /^moz([A-Z])/, Qf = {mouseleave: "mouseout", mouseenter: "mouseover"}, Sb = T("jqLite"), gf = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Rb = /<|&#?\w+;/, ef = /<([\w:]+)/, ff = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, ia = {option: [1, '<select multiple="multiple">',
    ...
    s({removeData: xb, on: function a(c, d, e, f) {
        ...
        }, stopPropagation: C, type: g, target: a}, c.type && (e = z(e, c)), c = qa(h), f = d ? [e].concat(d) : [e], s(c, function (c) {
    ...
    var Rc = /^((?:x|data)[\:\-_])/i, Vc = "application/json", Zb = {"Content-Type": Vc + ";charset=utf-8"}, tf = /^\[|^\{(?!\{)/, uf = {"[": /]$/, "{": /}$/}, sf = /^\)\]\}',?\n/, $b = T("$interpolate"), Sf = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/,
        xf = {http: 80, https: 443, ftp: 21}, Fb = T("$location"), Tf = {$$html5: !1, $$replace: !1, absUrl: Gb("$$absUrl"), url: function (a) {
            ...
            switch (arguments.length) {
                case 0:
                    return this.$$search;
                case 1:
                    if (H(a) || V(a))a = a.toString(), this.$$search = qc(a); else if (P(a))a = Ea(a, {}), s(a, function (c, e) {
                        null == c && delete a[e]
    ...
    gb.prototype = {constructor: gb, parse: function (a) {
        this.text = a;
        ...
        var a;
        return this.expect("+") ? this.primary() : (a = this.expect("-")) ? this.binaryFn(gb.ZERO,
    ...
    jd.$inject = ["$locale"];
    ld.$inject = ["$locale"];
    var od = ".", Mf = {yyyy: $("FullYear", 4), yy: $("FullYear", 2, 0, !0), y: $("FullYear", 1), MMMM: Ib("Month"),
            MMM: Ib("Month", !0), MM: $("Month", 2, 1), M: $("Month", 1, 1), dd: $("Date", 2), d: $("Date", 1), HH: $("Hours", 2), H: $("Hours", 1), hh: $("Hours", 2, -12), h: $("Hours", 1, -12), mm: $("Minutes", 2), m: $("Minutes", 1), ss: $("Seconds", 2), s: $("Seconds", 1), sss: $("Milliseconds", 3), EEEE: Ib("Day"), EEE: Ib("Day", !0), a: function (a, c) {
                return 12 > a.getHours() ? c.AMPMS[0] : c.AMPMS[1]
            }, Z: function (a) {
                a = -1 * a.getTimezoneOffset();
                return a = (0 <= a ? "+" : "") + (Hb(Math[0 < a ? "floor" : "ceil"](a / 60), 2) + Hb(Math.abs(a % 60), 2))
            }, ww: qd(2), w: qd(1)}, Lf = /((?:[^yMdHhmsaZEw']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|w+))(.*)/,
        Kf = /^\-?\d+$/;
    kd.$inject = ["$locale"];
        ...
        vb[c] = function () {
            return{priority: 99, link: function (d, e, f) {
                ...
                f.$observe(c, function (c) {
                    c ?
                        (f.$set(h, c), Qa && g && e.prop(g, f[h])) : "href" === a && f.$set(h, null)
                })
            }}
        }
    });
    var Jb = {$addControl: C, $$renameControl: function (a, c) {
        a.$name = c
    ...
    var yd = function (a) {
            return["$timeout", function (c) {
                return{name: "form", restrict: a ? "EAC" : "E", controller: rd, compile: function (a) {
                    ...
                    return{pre: function (a, d, g, h) {
                        ...
                        m && (fb(a, m, h, m), g.$observe(g.name ? "name" : "ngForm", function (c) {
                            m !== c && (fb(a, m, t, m), m = c, fb(a, m, h, m), k.$$renameControl(h, m))
                        }));
                        d.on("$destroy", function () {
                            k.$removeControl(h);
                            m && fb(a, m, t, m);
        ...
        Zf = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, $f = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, zd = /^(\d{4})-(\d{2})-(\d{2})$/, Ad = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, jc = /^(\d{4})-W(\d\d)$/, Bd = /^(\d{4})-(\d\d)$/, Cd = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, ag = /(\s+|^)default(\s+|$)/, Mb = new T("ngModel"), Dd = {text: function (a, c, d, e, f, g) {
            ib(a, c, d, e, f, g);
            hc(e)
        }, date: jb("date", zd, Lb(zd, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"), "datetime-local": jb("datetimelocal",
            Ad, Lb(Ad, "yyyy MM dd HH mm ss sss".split(" ")), "yyyy-MM-ddTHH:mm:ss.sss"), time: jb("time", Cd, Lb(Cd, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"), week: jb("week", jc, function (a, c) {
            if (pa(a))return a;
            if (H(a)) {
                jc.lastIndex = 0;
                var d = jc.exec(a);
            ...
            button: C, submit: C, reset: C, file: C}, xc = ["$browser", "$sniffer", "$filter", "$parse", function (a, c, d, e) {
            return{restrict: "E", require: ["?ngModel"], link: {pre: function (f, g, h, l) {
                l[0] && (Dd[Q(h.type)] || Dd.text)(f, g, h, l[0], c, a, d, e)
            }}}
        }], kb = "ng-valid", vd = "ng-invalid", Ra = "ng-pristine", Kb = "ng-dirty", xd = "ng-pending", bg = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function (a, c, d, e, f, g, h, l, k, m) {
            ...
            this.$$runValidators = function (a, c, d, e) {
                ...
                function g() {
                    ...
                    s(p.$asyncValidators, function (f, g) {
                        var k = f(c, d);
                        if (!k || !G(k.then))throw Mb("$asyncValidators", k);
                        h(g, t);
            ...
            this.$commitViewValue = function () {
                var a = p.$viewValue;
                h.cancel(O);
                if (p.$$lastCommittedViewValue !== a || "" === a && p.$$hasNativeValidators)p.$$lastCommittedViewValue =
                    a, p.$pristine && this.$setDirty(), this.$$parseAndValidate()
            };
            this.$$parseAndValidate = function () {
                var c = p.$$lastCommittedViewValue, d = D(c) ? t : !0;
                if (d)for (var e = 0; e < p.$parsers.length; e++)if (c = p.$parsers[e](c), D(c)) {
                    d = !1;
                    break
                }
                ...
                p.$$runValidators(d, c, p.$$lastCommittedViewValue, function (a) {
                    g || (p.$modelValue =
                        a ? c : t, p.$modelValue !== f && p.$$writeModelToScope())
                })
            };
            ...
            a.$watch(function () {
                ...
                if (c !== p.$modelValue) {
                    ...
                    p.$viewValue !== f && (p.$viewValue = p.$$lastCommittedViewValue = f, p.$render(), p.$$runValidators(t, c, f, C))
                }
                return c
            })
        }], ve = ["$rootScope", function (a) {
            return{restrict: "A", require: ["ngModel", "^?form", "^?ngModelOptions"], controller: bg, priority: 1, compile: function (c) {
                c.addClass(Ra).addClass("ng-untouched").addClass(kb);
        ...
        }], be = ic("", !0), de = ic("Odd", 0), ce = ic("Even", 1), ee = Ia({compile: function (a, c) {
            c.$set("ngCloak", t);
    ...
    var ie = ["$animate", function (a) {
        ...
        le = Ia({terminal: !0, priority: 1E3}), me = ["$locale", "$interpolate", function (a, c) {
        ...
        }}), se = Ia({transclude: "element", priority: 1200, require: "^ngSwitch", multiElement: !0, link: function (a, c, d, e, f) {
            e.cases["?"] = e.cases["?"] || [];
            ...
            return{restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
                ...
                function k(a, c, d, e) {
                    d.$render = function () {
                        var a = d.$viewValue;
                        e.hasOption(a) ? (C.parent() && C.remove(), c.val(a), "" === a && p.prop("selected", !0)) : D(a) && p ? c.val("") : e.renderUnknownOption(a)
                    };
                ...
                function n(e, f, g) {
                    ...
                    function k(a) {
                        ...
                        } else c = new cb(a); else M && (a = h(M, null,
                            a));
                        return function (d, e) {
                            var f;
                            f = M ? M : B ? B : F;
                ...
                if (l[1]) {
                    ...
                    var u = h.multiple, r = h.ngOptions,
                        z = !1, p, v = !1, w = B(Y.createElement("option")), G = B(Y.createElement("optgroup")), C = w.clone();
                    h = 0;
